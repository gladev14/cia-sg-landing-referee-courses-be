...
<head>
  ...
  <style>
    ...
    .header { background: #0c2356; padding: 22px 32px; border-bottom: 3px solid #2563eb; }
    .header h2 { margin: 0; font-size: 18px; font-weight: 700; color: #ffffff; letter-spacing: -0.01em; }
